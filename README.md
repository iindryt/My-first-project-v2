...
Šiame projekte naudojami **GoogleTest** testai, skirti patikrinti `Studentas` klasės funkcionalumą.  
Testai apima vidurkio skaičiavimą, kopijavimo konstruktorių ir priskyrimo operatorių.  

---

## Vidurkio skaičiavimo testas
